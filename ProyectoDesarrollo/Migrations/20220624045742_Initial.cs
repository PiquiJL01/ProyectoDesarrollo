        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Perito = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Id_Proveedor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Proveedor_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Proveedor_Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TallerID = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Id_Taller = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Direccion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Id_Poliza = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
