...
namespace TestProject.RCVUcab.UnitTests.Controllers.Administracion
{
    public class CotizacionControllerTest
    {
        ...
        public Task GetCotizacionesById()
        {
            ...
            var result = _controller.GetCotizacionesById("");
        ...
        public Task GetCotizacionesByIdException()
        {
            ...
            var ex = _controller.GetCotizacionesById("");
        ...
        public Task PutCotizacion()
        {
            ...
            var exist = _controller.GetCotizacionesById("");
        ...
        //DELETE Cotizacion UNIT TEST
        [Fact(DisplayName = "DELETE Cotizacion")]
        public Task DeleteCotizacion_Test()
        {
            ...
            var result = _controller.DeleteCotizacion(It.IsAny<string>());
        ...
        //DELETE Cotizacion UNIT TEST WITH EXCEPTION
        [Fact(DisplayName = "DELETE Cotizacion with Exception")]
        public Task DeleteCotizacion_WithException()
        {
            _serviceMock
                .Setup(x => x.Select(It.IsAny<string>()))
                .Throws(new RCVException("", new Exception()));
            ...
            var ex = _controller.DeleteCotizacion(It.IsAny<string>());
