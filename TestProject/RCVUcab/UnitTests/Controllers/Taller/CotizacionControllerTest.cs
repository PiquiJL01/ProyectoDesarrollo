...
namespace TestProject.RCVUcab.UnitTests.Controllers.Taller
{
    public class CotizacionControllerTest
    {
        ...
        //POST Cotizacion UNIT TEST
        [Fact(DisplayName = "POST Cotizacion")]
        public Task PostCotizacion()
        {
            _serviceMock
                .Setup(x => x.Insert(_sMock.Object));

            var result = _controller.PostCotizacion(_sMock.Object);
        ...
        //POST Cotizacion UNIT TEST WITH EXCEPTION
        [Fact(DisplayName = "POST Cotizacion with Exception")]
        public Task PostCotizacionException()
        {
            _serviceMock
                .Setup(x => x.Insert(_sMock.Object))
                .Throws(new RCVException("", new Exception()));

            var ex = _controller.PostCotizacion(_sMock.Object);
